  ...
  return (
    <MainCard classNames={`${classPrefix}-card`}>
      ...
      <ul>
        ...
        <li>
          <Trans>
            For users/smart contracts using Hedge Protocol perpetual contracts,
        ...
        <li>
          <Trans>
            1. Uncertainty risk of income: The calculation method of Hedge
            perpetual contract is different from the calculation method of
            perpetual contract of traditional centralized exchange. The Hedge
        ...
        <li>
          <Trans>
            2. Position liquidation risk: Hedge perpetual contracts provide
        ...
        <li>
          <Trans>
            4. External oracle risk: Hedge protocol's perpetual contract price
        ...
        <li>
          <Trans>
            5. Smart contract risk: The smart contract of the Hedge protocol has
