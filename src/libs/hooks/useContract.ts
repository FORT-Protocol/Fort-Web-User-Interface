import {CofixSwapAddress, FortLPGuaranteeAddress, NestPrice as NestPriceAddress} from './../constants/addresses';
...
import FortLPGuaranteeABI from '../../contracts/abis/FortLPGuarantee.json'
...
export function FortLPGuaranteeContract(): Contract | null {
    return useContract(FortLPGuaranteeAddress, FortLPGuaranteeABI)
}
